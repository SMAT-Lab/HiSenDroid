...
public class AnalysisParameters {
  private static edu.psu.cse.siis.coal.AnalysisParameters instance = new edu.psu.cse.siis.coal.AnalysisParameters();
   ...
   */
  public static edu.psu.cse.siis.coal.AnalysisParameters v() {
    return instance;
  }
