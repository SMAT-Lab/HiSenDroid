...
public class PathValue {
   ...
   */
  public Set<edu.psu.cse.siis.coal.values.PathValue> makeFinalBranchValues(PropagationSolver solver) {
    ...
    Set<edu.psu.cse.siis.coal.values.PathValue> result = new HashSet<>();
