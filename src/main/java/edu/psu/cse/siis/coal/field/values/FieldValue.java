 ...
 * problem.
 */
public abstract class FieldValue implements Internable<edu.psu.cse.siis.coal.field.values.FieldValue> {
  private static final Pool<edu.psu.cse.siis.coal.field.values.FieldValue> POOL = new Pool<>();
  ...
  @Override
  public edu.psu.cse.siis.coal.field.values.FieldValue intern() {
