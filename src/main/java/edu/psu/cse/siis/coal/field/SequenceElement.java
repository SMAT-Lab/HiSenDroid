...
public class SequenceElement {
  ...
  public boolean equals(Object other) {
    if (!(other instanceof edu.psu.cse.siis.coal.field.SequenceElement)) {
      return false;
    }
    edu.psu.cse.siis.coal.field.SequenceElement secondSequenceElement = (edu.psu.cse.siis.coal.field.SequenceElement) other;
