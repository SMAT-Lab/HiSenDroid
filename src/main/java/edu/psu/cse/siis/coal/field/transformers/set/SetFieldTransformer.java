...
public class SetFieldTransformer extends FieldTransformer {
  ...
  public FieldTransformer compose(FieldTransformer secondFieldOperation) {
    ...
    assert secondFieldOperation instanceof edu.psu.cse.siis.coal.field.transformers.set.SetFieldTransformer;

    edu.psu.cse.siis.coal.field.transformers.set.SetFieldTransformer secondFieldTransformer = (edu.psu.cse.siis.coal.field.transformers.set.SetFieldTransformer) secondFieldOperation;

    if (secondFieldTransformer.clear) {
      return secondFieldOperation;
    }

    edu.psu.cse.siis.coal.field.transformers.set.SetFieldTransformer result = new edu.psu.cse.siis.coal.field.transformers.set.SetFieldTransformer();
  ...
  public FieldTransformer makeNonComposedFieldTransformer() {
    edu.psu.cse.siis.coal.field.transformers.set.SetFieldTransformer intermediateFieldTransformer = new edu.psu.cse.siis.coal.field.transformers.set.SetFieldTransformer();
  ...
  public boolean equals(Object other) {
    if (!(other instanceof edu.psu.cse.siis.coal.field.transformers.set.SetFieldTransformer)) {
      return false;
    }
    edu.psu.cse.siis.coal.field.transformers.set.SetFieldTransformer secondFieldTransformer = (edu.psu.cse.siis.coal.field.transformers.set.SetFieldTransformer) other;
