 ...
 */
public abstract class FieldTransformer implements Internable<edu.psu.cse.siis.coal.field.transformers.FieldTransformer> {
  private static final Pool<edu.psu.cse.siis.coal.field.transformers.FieldTransformer> POOL = new Pool<>();
   ...
   */
  public abstract edu.psu.cse.siis.coal.field.transformers.FieldTransformer compose(edu.psu.cse.siis.coal.field.transformers.FieldTransformer secondFieldOperation);

  @Override
  public edu.psu.cse.siis.coal.field.transformers.FieldTransformer intern() {
