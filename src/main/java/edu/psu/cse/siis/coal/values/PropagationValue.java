 ...
 */
public class PropagationValue implements BasePropagationValue, Internable<edu.psu.cse.siis.coal.values.PropagationValue> {
  private static final Pool<edu.psu.cse.siis.coal.values.PropagationValue> POOL = new Pool<>();
