...
public class PropagationTimers {
  private static edu.psu.cse.siis.coal.PropagationTimers instance = new edu.psu.cse.siis.coal.PropagationTimers();

  private PropagationTimers() {
  }

  public static edu.psu.cse.siis.coal.PropagationTimers v() {
  ...
  public static void clear() {
    instance = new edu.psu.cse.siis.coal.PropagationTimers();
  }
